            ...
            {isAdmin && (
              <div className="flex items-center gap-3 pl-4 border-l border-slate-100">
                <button 
                  onClick={handleSync}
                  disabled={isSyncing}
                  className="bg-slate-50 text-slate-500 px-3 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 hover:text-slate-900 transition-all flex items-center gap-2 disabled:opacity-50 border border-slate-100"
                >
                ...
                <button 
                  ...
                  className="bg-slate-900 text-white px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-lg shadow-slate-200"
                >
                  Add Product
                </button>
              </div>
